...
const allSkills = [
  ...
  { name: 'Next.js', iconPath: '/icons/skills/nextjs.svg', invertInDark: true },
  ...
  { name: 'AWS', iconPath: '/icons/skills/aws.svg', darkIconPath: '/icons/skills/aws-dark.svg' },
  ...
  { name: 'Vercel', iconPath: '/icons/skills/vercel.svg', invertInDark: true },
  { name: 'GitHub Actions', iconPath: '/icons/skills/githubactions.svg', invertInDark: true },
            ...
            {skill.darkIconPath ? (
              <>
                <Image
                  ...
                  width={36}
                  height={36}
                  className="opacity-70 group-hover:opacity-100 transition-all duration-200 dark:hidden"
                />
                <Image
                  ...
                  width={36}
                  height={36}
                  className="opacity-70 group-hover:opacity-100 transition-all duration-200 hidden dark:block"
                />
              </>
            ) : (
              <Image
                ...
                className={`opacity-70 group-hover:opacity-100 transition-all duration-200 ${
                  skill.invertInDark ? 'dark:invert dark:opacity-90 dark:group-hover:opacity-100' : ''
                }`}
              />
            )}
